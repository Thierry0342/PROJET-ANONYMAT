...
const WelcomePage = ({ onComplete }) => {
    ...
    return (
        <div className="welcome-page-container">
            {/* SVG d'animation Uiverse (inchangé) */}
            ...
            {/* CHANGEMENT ICI : loading-text devient welcome-loading-text */}
            <p className="welcome-loading-text">Préparation de votre espace de travail...</p>
        </div>
    );
};
